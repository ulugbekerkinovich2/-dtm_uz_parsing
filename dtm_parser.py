                    ...
                    for i in range(1, 8):
                        try:
                            ...
                            for yonalish in t_yonalish:
                                try:
                                    time.sleep(3)
                                    shtrix_code = str(yonalish.find_elements(By.TAG_NAME, 'td')[0].find_element(By.TAG_NAME,
                                                                                                                'div').get_attribute(
                                        'textContent'))
                                    time.sleep(1)
                                    # print(shtrix_code)
                                    ...
                                    nomi = str(
                                        yonalish.find_elements(By.TAG_NAME, 'td')[0].find_element(By.TAG_NAME, 'a').text)
